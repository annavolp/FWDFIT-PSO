...
;map_out.xc = vis[0].xyoffset[0]
;map_out.yc = vis[0].xyoffset[1]
...
roll_angle = stx_get_roll_angle(this_time_range[0])
map_out.roll_angle = roll_angle

;; Roll angle correction
;roll_angle = stx_get_roll_angle(this_time_range[0])
;map_out = rot_map(map_out,-roll_angle,rcenter=[0.,0.])
;map_out.roll_angle = 0.
;
;;; Mapcenter corrected for Frederic's mean shift values
;map_out.xc += 26.1
;map_out.yc += 58.2
